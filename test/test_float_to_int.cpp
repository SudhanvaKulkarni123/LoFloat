...
bool F2I_test() {
    using fp = P_3109_float<k, p, Signedness::Signed, Inf_Behaviors::Saturating>;
...
int main() {
    ...
    // std::cout << "checkinf conversion of -8 to e1m1 : " << (int)(P_3109_float<3, 1, Signedness::Signed, Inf_Behaviors::Saturating>(-7)).rep() << "\n";
    // // std::cout << "printing all possible e1m1 values : " << std::endl;
    // // for(uint8_t i = 0; i < 8; i++) {
    // //     std::cout << (float) P_3109_float<3, 1, Signedness::Signed, Inf_Behaviors::Saturating>::FromRep(i) << "\n";
    // // }
    // // std::cout << "chyeckinhg operator-\n";
    // // std::cout << (float)-P_3109_float<3, 1, Signedness::Signed, Inf_Behaviors::Saturating>(7) << "\n";
